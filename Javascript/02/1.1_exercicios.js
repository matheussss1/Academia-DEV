 ...
 * 
 * 
 * 1 - Liste quais tipos de declaração de variavel podem iniciar sem valor
 * 
 * 2 - Explique com suas palavras a diferença entre variaveis inicializadas e não inicializadas
 * 
 * 3 - Liste quais tipos de declaração de variavel podem ser reedeclaradas
 * 
 * 4 - Liste quais tipos de declaração de variavel podem ser reescritas
 * 
 * 5 - Qual a diferença entre sobreescrever e redeclarar uma variavel?
 * 
